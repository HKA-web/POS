...
//table header
$cols = array("A","B","C");
$val = array("NO","KODE KATEGORI","NAMA KATEGORI");
...
foreach ($data->result() as $row){ 
	...
	$objset->setCellValue("B".$baris, $row->kd_kategori);
	$objset->setCellValue("C".$baris, $row->nm_kategori);
	$baris++;
}
$objPHPExcel->getActiveSheet()->setTitle('Rekap Kategori');

$objPHPExcel->setActiveSheetIndex(0);  
$filename = urlencode("Rekap_Kategori_".date("d-m-Y").".xls");
