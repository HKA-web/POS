...
$val = array("NO","BULAN/TAHUN","NO.PEMBELIAN","KODE BARANG","NAMA BARANG","JUMLAH","HARGA BELI","SUB TOTAL");
...
$objPHPExcel->getActiveSheet()->setTitle('Rekap Pembelian Perbulan');

$objPHPExcel->setActiveSheetIndex(0);  
$filename = urlencode("Rekap_Pembelian_Perbulan_".$param."_".date("d-m-Y").".xls");
