...
$val = array("NO","KODE BARANG","NAMA BARANG","KODE KATEGORI","NAMA KATEGORI");
...
foreach ($data->result() as $row){ 
	...
	$objset->setCellValue("D".$baris, $row->kd_kategori);
	$objset->setCellValue("E".$baris, $row->nm_kategori);
	$baris++;
}
$objPHPExcel->getActiveSheet()->setTitle('Rekap Barang PerKategori');

$objPHPExcel->setActiveSheetIndex(0);  
$filename = urlencode("Rekap_Barang_PerKategori_".$param."_".date("d-m-Y").".xls");
