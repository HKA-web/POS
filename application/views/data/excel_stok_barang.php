...
//table header
$cols = array("A","B","C","D");
$val = array("NO","KODE BARANG","NAMA BARANG","PERSEDIAAN");
...
foreach ($data->result() as $row){ 
	...
	$objset->setCellValue("D".$baris, $row->stok);
	$baris++;
}
$objPHPExcel->getActiveSheet()->setTitle('Rekap Persediaan Barang');

$objPHPExcel->setActiveSheetIndex(0);  
$filename = urlencode("Rekap_Persediaan_Barang_".date("d-m-Y").".xls");
