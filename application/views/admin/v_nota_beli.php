...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr >
      <td colspan="4" style="text-align: right;">Terimakasih: atas kunjangannya,sampai jumpa</td>
  ...
  <div class="row">
      ...
      <div class="col-xs-6">
        ...
        <div class="panel panel-info"  style="text-align: right;">
          <h6>PERINGATAN : "PASTIKAN KONDISI BARANG YANG DI BELI"</h6>
        </div>
