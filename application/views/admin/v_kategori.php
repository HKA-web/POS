      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" id="kd_kategori" placeholder="Otomatis">
                      </div>
                  </div>
              <div class="form-group">
                  <label for="inputUserName" class="col-sm-4 control-label">Nama Kategori</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="nm_kategori" placeholder="Nama Kategori" required>
                  </div>
              </div>
          </div>
...
<script>
  ...
  $(document).ready(function(){
        $('#input').on('submit',function(e){
            e.preventDefault();
            var kode=$('#kd_kategori').val();
            var nama=$('#nm_kategori').val();
            $.ajax({
  ...
  function view() {
    $.ajax({
      type: 'GET',
      url: '<?php echo base_url();?>kategori/data_kategori',
      success: function(data) {
      $('#tampilkan').html(data);
      }
    });
  ...
  function pilihDataHapus(kode) {
    ...
    $.ajax({
      type: 'GET',
      data: 'kode='+kode,
      url: '<?php echo base_url();?>kategori/detail_hapus',
      success: function(data) {
